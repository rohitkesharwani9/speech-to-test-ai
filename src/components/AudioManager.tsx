...
function SettingsModal(props: {
    ...
    const models = {
        ...
        // new model name
        // 'Rohit/whisper-tiny': [41, 152],
        // 'Rohit/whisper-base': [77, 291],
        // 'Rohit/whisper-small': [249],
        // 'Rohit/whisper-medium': [776],
    ...
    return (
        <Modal
            ...
            content={
                <>
                    <label>Select the model you want to use (larger models offer better accuracy than smaller ones). <b>Check the 'Quantized' option to show all LLM models.</b></label>
                    <select
